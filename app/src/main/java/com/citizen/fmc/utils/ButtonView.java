...
/**
 * ======> Created by dheeraj-gangwar on 2017-12-22 <======
 */

public class ButtonView extends AppCompatButton implements View.OnTouchListener {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            } else if (attr == R.styleable.ButtonView_shadowHeight) {
